...
import {getUserProfile, login, register, sendSmsToPhone} from './auth.actions';
...
export default createReducer(initialState, (builder) =>
  builder
    ...
    .addCase(register.fulfilled, (state, {payload}) => {
      ...
      console.log('reg response', payload.data);
      const {token, id, email, username, roles, phone} = payload;
      state.loading = false;
      state.error = null;
      state.token = token;
