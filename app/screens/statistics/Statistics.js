...
import { getAllStats, getStatsBySubject } from '../../../redux/statistics/statistics.actions'
    ...
    <View style={styles.statBlock}>
        ...
        <View style={styles.statBlockResults}>
            <Text style={styles.statBlockSubtitle} >
                Правильних відповідей  <Text style={{ color: Colors.success }}>{item.correct}</Text>
                 /
...
const Statistics = ({ route, navigation }) => {
    ...
    return (
        <>
            ...
            {!loading ? <View style={styles.statCont}>
                <FlatList
                    data={[...stats]}
