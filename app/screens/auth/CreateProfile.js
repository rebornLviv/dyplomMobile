...
const CreateProfile = ({route: {params}}) => {
  ...
  return (
    <View style={Styles.screen}>
      <Welcoming greet="привіт" head="Вхід у профіль" />
      <View style={contentCont}>
        <View style={Styles.formContainer}>
          ...
          {!hasReferal && (
            <TouchableOpacity style={mentionRef} onPress={toggleReferal}>
        ...
        <View>
          ...
          <View style={policyCont}>
            <View style={Styles.row}>
              <View style={highlited}>
                <Text style={Styles.secondaryText}>
                  Продовжуючи, ти погоджуєшся з{' '}
                </Text>
              </View>
              <TouchableOpacity style={highlited}>
                <Text style={Styles.actionText}>Політикою </Text>
              </TouchableOpacity>
            </View>
            <View style={Styles.row}>
              <TouchableOpacity style={highlited}>
                <Text style={Styles.actionText}>конфідеційності </Text>
              </TouchableOpacity>
              <View style={highlited}>
                <Text style={Styles.secondaryText}>та </Text>
              </View>
              <TouchableOpacity style={highlited}>
                <Text style={Styles.actionText}>Умовами використання</Text>
              </TouchableOpacity>
            </View>
          </View>
        </View>
